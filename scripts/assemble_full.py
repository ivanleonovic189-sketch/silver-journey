...
PLAN = [
    ...
    (57.0,  59.5, "Папа Сергея",      ("video", "Папа Сергея", "ФОТО ФИНАЛ/2.jpg")),
    (59.5,  62.0, "Мама Сергея",      ("video", "Мама Сергея", "ФОТО ФИНАЛ/25.jpg")),
    (62.0,  64.0, "Папа Сергея",      ("video", "Папа Сергея", "ФОТО ФИНАЛ/17.jpg")),
    (64.0,  67.0, "Мама Сергея",      ("video", "Мама Сергея", "ФОТО ФИНАЛ/1.jpg")),
    (67.0,  69.0, "Папа Люды",        ("video", "Папа Люды", "ФОТО ФИНАЛ/23.jpg")),
    (69.0,  71.0, "Мама Люды",        ("video", "Мама Люды", "ФОТО ФИНАЛ/14.jpg")),
    (71.0,  74.0, "Папа Люды",        ("video", "Папа Люды", "ФОТО  БЛОК лЮДА 2/1 ВСТРЕТИЛИСЬ.jpg")),
    (74.0,  75.5, "Мама Люды",        ("video", "Мама Люды", "ФОТО  БЛОК лЮДА 2/6 МИРИЛИСЬ.jpg")),
    (75.5,  79.0, "Серёжечка",        ("photos", ["СЕРЕЖЕЧКА.jpg"])),
    (79.0,  80.0, "Женечка",          ("video", "Женечка", "БЫЛИ ДРУЗЬЯМИ/1.jpg")),
    ...
    (123.0, 127.0, "Миша",            ("video", "Миша", "МИША/ВЗЯТО.jpg")),
    ...
    (146.0, 155.0, "Миша",            ("video", "Миша", "МИША/ПОБЕДА.jpg")),
    (155.0, 162.0, "Кирилл",          ("video", "Кирилл", "КИРИЛЛ")),
    ...
    (180.0, 186.0, "Ольга",           ("video", "Ольга", "ФОТО ФИНАЛ/16.jpg")),
    (186.0, 191.0, "Руслан",          ("video", "Руслан", "ВСТРЕЧА С РУСЛАНОМ.jpg")),
    (191.0, 197.0, "Руслан / фото",   ("photos", ["ВСТРЕЧА С РУСЛАНОМ.jpg"])),
    (197.0, 200.0, "Руслан",          ("video", "Руслан", "ФОТО ФИНАЛ/38.jpg")),
    (200.0, 204.0, "Эвелина",         ("video", "Эвелина", "эВЕЛИНА/РОДНОЙ.jpg")),
    (204.0, 208.0, "Эвелина / фото",  ("photos", ["эВЕЛИНА/НАША ДАТА.jpg"])),
    (208.0, 213.0, "Эвелина / фото",  ("photos", ["эВЕЛИНА/РАЗДЕЛИЛИ.jpg"])),
    (213.0, 218.0, "Эвелина",         ("video", "Эвелина", "эВЕЛИНА/НАША ДАТА.jpg")),
    ...
    (269.0, 271.0, "Ксю",             ("video", "Ксю", "ФОТО КСЮ/ЛЮБЛЮ.jpg")),
    (271.0, 280.0, "Ксю / фото",      ("photos", ["ФОТО КСЮ"])),
    (280.0, 290.0, "Ирочка Василега", ("video", "Ирочка Василега", "иРОЧКА вАСИЛЕГА ФОТО")),
...
def readable(path):
    """Битые/недокачанные файлы в монтаж не берём."""
    try:
        Image.open(path).load()
        return True
    except Exception:
        print("пропущен битый файл:", os.path.basename(path))
        return False
...
def expand(src, items):
    ...
    return [p for p in out if readable(p)]
